...
if [ "$INPUT_TARGET" = "x86_64-unknown-linux-gnu" ]; then
    ...
    apt-get update
    apt-get install -y libncurses6:arm64 libtinfo6:arm64 linux-libc-dev:arm64 libncursesw6:arm64 libcups2:arm64 libasound2-dev:arm64
    ...
    apt-get update
    apt-get install -y libncurses6:armhf libtinfo6:armhf linux-libc-dev:armhf libncursesw6:armhf libcups2:armhf libasound2-dev:armhf
